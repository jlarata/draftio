...
import { TableCellsIcon, TrophyIcon, UserCircleIcon } from '@heroicons/react/24/outline'
...
export default function CreateForm({
  ...
  const handleCreateRound = async (e: React.MouseEvent<HTMLButtonElement>) => {
    e.preventDefault()
    setIsLoading(true)
    ...
    formData.append('player1_id', player1)
    formData.append('player1_wins', p1Wins)
    formData.append('player2_id', player2)
    formData.append('player2_wins', p2Wins)
        ...
        <div className='rounded-md bg-gray-50 p-4 md:p-6'>
          ...
          <div className='mb-4'>
            <label htmlFor='p1wins' className='mb-2 block text-sm font-normal'>
              {player1
                ? players.map((player) => (player.id === player1 ? player.username + ' Wins' : null))
                : 'Player Wins'}
            </label>
            <div className='relative'>
              <select
          ...
          {/* Player 2 */}
          <div className='mb-4'>
            <label htmlFor='player 2' className='mb-2 block text-sm font-medium'>
              Choose Player 2
            </label>
            <div className='relative'>
              <select
          ...
          <div className='mb-4'>
            <label htmlFor='p2wins' className='mb-2 block text-sm font-normal'>
              {player2
                ? players.map((player) => (player.id === player2 ? player.username + ' Wins' : null))
                : 'Player Wins'}
            </label>
            <div className='relative'>
              <select
              ...
              >
                ...
                <option value='0'>0</option>
                <option value='1'>1</option>
                <option value='2' disabled={p1Wins === '2'}>
                  2
                </option>
              </select>
              <UserCircleIcon className='pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500' />
