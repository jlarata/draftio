...
const fetchedTournaments = await fetchTournamentDataByLeagueId("00000000-0000-0000-0000-000000000000")
//of course the id of the league should not be hardcoded
    ...
    <>
      ...
      <div className="w-full">
        <div className="flex w-full items-center justify-between">
          <h1 className={`${inter.className} text-2xl`}>All tournaments</h1>
        </div>
       {/*
       ...
       <div className="mt-4 flex items-center justify-between gap-2 md:mt-8">
        ...
        <Suspense key={query + currentPage} fallback={<LatestGamesSkeleton />}>
           <TournamentsTable query={query} currentPage={currentPage}></TournamentsTable>
